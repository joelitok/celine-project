        ...
        <div class="banner_inner d-flex align-items-center">
            ...
            <div class="container">
                <div class="row justify-content-center">
                            ...
                            <div class="col-sm-6">  
                                <video controls id="emitter_vid"  width="100%" height="400px"></video>   
                            </div>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <ul class="blog_meta list">
                        ...
                        <li><a href="#"><i class="lnr lnr-calendar-full"></i></a></li>
                        <li><a href="#"><i class="lnr lnr-eye"></i></a></li>
                        <li><a href="#"><i class="lnr lnr-bubble"></i></a></li>
                    </ul>
                    <div class="blog_info">
                        <video controls id="emitter_vid"  width="100%" height="200px"></video>
                    </div>
                    <!-- <ul class="blog_meta list">
                        <li><a href="#"><i class="lnr lnr-user"></i></a></li>
                        <li><a href="#"><i class="lnr lnr-calendar-full"></i></a></li>
