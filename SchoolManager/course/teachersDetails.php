...
<div class="super_container">
	...
	<div class="home">
		...
		<div class="home_content">
			<h1>information a propos de Mr/Mme </h1>
		</div>
	</div>
					...
					<div class="news_post_container">
						...
						<?php if($row['photo']){?>
							...
							<div class="news_post_image">
								<img src="../profiles/<?php  echo $row['photo']?>"   height="300px">
							</div>
							 <?php }else{?>
							 <div class="news_post_image">
								<img src="../assets/images/person-icon.png"  alt="https://unsplash.com/@dsmacinnes">
							</div>
							 <?php }?>
							<div class="news_post_top d-flex flex-column flex-sm-row">
								<div class="news_post_date_container">
									<div class="news_post_date d-flex flex-column align-items-center justify-content-center">
										<div><?php echo date("yy");?></div>
								...
								<div class="news_post_title_container">
									...
									<div class="news_post_title">
										<a href="news_post.html">Nom : <?php echo ucfirst($row['name']) ?></a>
									</div>
									<div class="news_post_meta">
										<span class="news_post_author"><a href="#">Type : <?php echo ucfirst($row['user_type']) ?></a></span>
										<span><?php echo $row['date']?>|</span>
										<span class="news_post_comments"><a href="#">Email : <?php echo $row['email_address']?></a></span>
									</div>
								</div>
							</div>
