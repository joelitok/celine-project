			...
			<nav class="main_nav_container">
				<div class="main_nav">
					<ul class="main_nav_list">
						...
						<li class="main_nav_item"><a href="course.php">Course</a></li>
...
<?php if($numRows1==0){ ?>
  ...
  Vous pouvez ajouter un nouveau compte enseignant car  il n'existe aucun compte enseignant
   <a href="index.php" class="click-btn btn btn-default"> <span>back</span></a>
</div>
...
<?php if($row1['user_type']=='Teacher'){ $num1+=1 ?>
				...
				<div class="col-lg-4 teacher">
					<div class="card">
						<div class="card_img">
							<div class="card_plus trans_200 text-center"><a href="teachersDetails.php?id=<?php echo $row1['iduser']?>">+</a></div>
							 <?php if($row1['photo']){ ?>
							<img class="card-img-top trans_200" src="../profiles/<?php echo $row1['photo'];  ?>" height="350px" width="480px">
							 <?php }else{?>
							 <img class="card-img-top trans_200" src="../profiles/user-image.png"  >
							  <?php }?>
						</div>
						<div class="card-body text-center">
							<div class="card-title"><a href="#"><?php echo ucfirst($row1['name']);  ?></a></div>
							<div class="card-text"><?php echo ucfirst($row1['email_address']); ?></div>
